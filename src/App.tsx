...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Footer con información del autor y enlaces */}
      <footer className="px-3 md:px-4 py-8 mt-8 bg-background/40 rounded-lg">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="text-sm text-muted-foreground">
            <span>{STRINGS[locale].footer_created_by} </span>
            <a 
              href="https://www.linkedin.com/in/santiagorafaelparadelo/" 
              target="_blank" 
          ...
          <div className="text-sm text-muted-foreground max-w-2xl mx-auto">
            {STRINGS[locale].footer_clone_project}
          </div>
          
          <div className="flex items-center justify-center gap-4 text-sm">
            <a 
              href="https://github.com/sparadeloweb/tracklistdownloaderapi" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="https://github.com/sparadeloweb/tracklistdownloader" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors"
            >
